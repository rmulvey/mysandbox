/*----------------------------------------------------------------------------
 * File:  CSOClientListener_sys_types.h
 *
...
#ifndef CSOCLIENTLISTENER_SYS_TYPES_H
#define CSOCLIENTLISTENER_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#define CSOListener_DOMAIN_ID 0
#define CSOListener_DOMAIN_ID_text "CSOListener"
...
#endif
#endif  /* CSOCLIENTLISTENER_SYS_TYPES_H */
